...
This package currently provides two nodes under `audio/AceStep SFT`:
...
- **generate_audio_codes** (default: True): Enable/disable LLM audio code generation
...
AceStepSFTGenerate:
  ...
  → Synthesizes using timbral characteristics from piano
```
